...
import com.ston.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<Categoria> pagina = service.findPage(page, linesPerPage, orderBy, direction);
		Page<CategoriaDTO> paginaDto = pagina.map(categoria -> new CategoriaDTO(categoria));
